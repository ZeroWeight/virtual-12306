...
QT_MOC_LITERAL(1, 5, 3), // "Ans"
QT_MOC_LITERAL(2, 9, 0), // ""
QT_MOC_LITERAL(3, 10, 8), // "is_LogIn"
QT_MOC_LITERAL(4, 19, 12) // "_Communicate"

    },
    "Info\0Ans\0\0is_LogIn\0_Communicate"
};
...
void Info::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Ans((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->is_LogIn(); break;
        case 2: _t->_Communicate(); break;
        default: ;
        }
        ...
        {
            typedef void (Info::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Info::Ans)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Info::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Info.data,

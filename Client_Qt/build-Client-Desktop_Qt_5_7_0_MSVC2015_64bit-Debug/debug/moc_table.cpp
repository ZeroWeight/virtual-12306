...
QT_MOC_LITERAL(1, 6, 3), // "Buy"
QT_MOC_LITERAL(2, 10, 0), // ""
QT_MOC_LITERAL(3, 11, 5), // "Route"
QT_MOC_LITERAL(4, 17, 6), // "Reload"
QT_MOC_LITERAL(5, 24, 7), // "Details"
QT_MOC_LITERAL(6, 32, 3), // "col"
QT_MOC_LITERAL(7, 36, 3), // "row"
QT_MOC_LITERAL(8, 40, 4), // "Push"
QT_MOC_LITERAL(9, 45, 4) // "show"

    },
    "Table\0Buy\0\0Route\0Reload\0Details\0col\0"
    "row\0Push\0show"
};
...
void Table::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Buy((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->Route((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->Reload((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 3: _t->Details((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: _t->Push(); break;
        ...
        {
            typedef void (Table::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Table::Buy)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Table::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Table::Route)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Table::Reload)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void Table::Reload(int _t1, bool _t2)
{

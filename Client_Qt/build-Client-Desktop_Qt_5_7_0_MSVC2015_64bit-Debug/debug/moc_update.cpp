...
QT_MOC_LITERAL(1, 7, 7), // "OK_Send"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 11), // "Cancle_Send"
QT_MOC_LITERAL(4, 28, 9), // "DueToType"
QT_MOC_LITERAL(5, 38, 1), // "s"
QT_MOC_LITERAL(6, 40, 2), // "OK"
QT_MOC_LITERAL(7, 43, 6), // "Cancle"
QT_MOC_LITERAL(8, 50, 4) // "show"

    },
    "Update\0OK_Send\0\0Cancle_Send\0DueToType\0"
    "s\0OK\0Cancle\0show"
};
...
void Update::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Update::OK_Send)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Update::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Update::Cancle_Send)) {
                *result = 1;
                return;
            }
        }
